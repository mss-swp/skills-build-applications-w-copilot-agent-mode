...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for activity in activities:
            activity.save()
            print(f"Inserted activity: {activity.activity_type}")
        ...
        for entry in leaderboard_entries:
            entry.save()
            print(f"Inserted leaderboard entry for user: {entry.user.username} with score: {entry.score}")
        ...
        for workout in workouts:
            workout.save()
            print(f"Inserted workout: {workout.name}")
